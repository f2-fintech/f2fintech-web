  ...
  const faqs = [
    {
      ...
      answer: "OD (Overdraft) allows you to withdraw funds as needed and pay interest only on the utilized amount, while EMI requires fixed monthly payments regardless of usage. OD is ideal for working capital needs with fluctuating requirements."
    },
    {
      question: "Can I get 100% financing for medical equipment?",
      answer: "Yes, many lenders offer up to 100% financing for medical equipment to registered practitioners. The exact percentage depends on the equipment type, your profile, and lender policies."
    },
    {
      question: "How is eligibility calculated for fresh practitioners?",
      answer: "Fresh practitioners with 1-3 years of experience are evaluated based on their medical registration, educational qualifications, practice setup, and projected income rather than historical financial data."
    },
    {
      question: "What documents prove my practice?",
      answer: "Medical registration certificate, clinic lease agreement, patient appointment records, billing software data, and utility bills of the practice location serve as proof of your medical practice."
    },
    {
      question: "What's the typical time to disbursal for doctor loans?",
      answer: "Doctor loans typically get disbursed within 7-15 working days due to faster KYC processes for registered medical practitioners and streamlined documentation requirements."
    }
  ];
                ...
                <Grid container spacing={4}>
                  ...
                  <Grid item xs={12} md={6}>
                    <Card sx={{ backgroundColor: '#e3f2fd', p: 3 }}>
                      ...
                      <Typography variant="body2" sx={{ mb: 2 }}>Monthly EMI</Typography>
                      <Divider sx={{ my: 2 }} />
                ...
                <Grid container spacing={4}>
                  ...
                  <Grid item xs={12} md={6}>
                    <Card sx={{ backgroundColor: '#e8f5e8', p: 3 }}>
                      ...
                      <Typography variant="body2" sx={{ mb: 2 }}>Monthly Interest Cost</Typography>
                      <Divider sx={{ my: 2 }} />
                      <Typography variant="body1">
