...
const MAX_AMOUNT = 7500000; // 75 Lakh
const MIN_TENURE = 12;
...
const DoctorLoanPage = () => {
  ...
  const handleAmountInput = (e) => {
    ...
    setLoanAmount(Math.min(num, 7500000));
  };
  ...
  const handleRateInput = (e) => {
    ...
    if (!isNaN(num)) {
      setInterestRate(Math.min(num, 50));
    }
  };
  ...
  const handleOdLimitInput = (e) => {
    const val = e.target.value.replace(/[^0-9]/g, "");
    const num = val === "" ? 0 : parseInt(val, 10);
    setOdLimit(Math.min(num, 7500000));
  };

  const handleUtilizationInput = (e) => {
    const val = e.target.value.replace(/[^0-9]/g, "");
    const num = val === "" ? 0 : parseInt(val, 10);
    setUtilization(Math.min(num, 100));
  };
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <Box sx={{ minHeight: "100vh", backgroundColor: "#f8f9fa" }}>
        ...
        <Container component="section" aria-labelledby="about-doctor-loans" maxWidth="lg" sx={{ py: { xs: 4, md: 8 } }}>
          <Typography
            variant="h2"
            id="about-doctor-loans"
            sx={{
                ...
                <CardContent sx={{ p: 3 }}>
                  ...
                  <List dense>
                    <ListItem sx={{ px: 0 }}>
                      ...
                      <ListItemText primary="MBBS/MD/BDS and registered practitioners" />
                    </ListItem>
                    <ListItem sx={{ px: 0 }}>
                      <ListItemIcon sx={{ minWidth: 30 }}>
                        <CheckCircleIcon
                    ...
                    <ListItem sx={{ px: 0 }}>
                      ...
                      <ListItemText primary="Diagnostic centers and nursing homes" />
                    </ListItem>
                  </List>
                </CardContent>
              </Card>
                ...
                <CardContent sx={{ p: 3 }}>
                  ...
                  <List dense>
                    ...
                    <ListItem sx={{ px: 0 }}>
                      ...
                      <ListItemText primary="Special pricing/terms for medical professionals" />
                    </ListItem>
                  </List>
                </CardContent>
              </Card>
                ...
                <CardContent sx={{ p: 3 }}>
                  ...
                  <List dense>
                    ...
                    <ListItem sx={{ px: 0 }}>
                      ...
                      <ListItemText primary="Flexible overdraft (OD) lines available" />
                    </ListItem>
                    <ListItem sx={{ px: 0 }}>
                      <ListItemIcon sx={{ minWidth: 30 }}>
                        <CheckCircleIcon
                      ...
                      <ListItemText primary="Faster KYC and special doctor desk checks" />
                    </ListItem>
                  </List>
                </CardContent>
              </Card>
              ...
              >
                ...
                <List>
                  <ListItem>
                    ...
                    <ListItemText primary="Valid medical registration certificate" />
                  </ListItem>
                  <ListItem>
                    <ListItemIcon>
                      <CheckCircleIcon sx={{ color: "green" }} />
                    </ListItemIcon>
                    <ListItemText primary="Minimum practice vintage (1–3 years)" />
                  </ListItem>
                  <ListItem>
                    <ListItemIcon>
                      <CheckCircleIcon sx={{ color: "green" }} />
                    </ListItemIcon>
                    <ListItemText primary="Credit profile and score in good standing" />
                  </ListItem>
                </List>
              </Paper>
            </Grid>
              ...
              >
                ...
                <List>
                  <ListItem>
                    ...
                    <ListItemText primary="PAN, Aadhaar, and Address proof" />
                  </ListItem>
                  <ListItem>
                    <ListItemIcon>
                      <CheckCircleIcon sx={{ color: "green" }} />
                  ...
                  <ListItem>
                    ...
                    <ListItemText primary="Income proof / ITRs / Clinic financials" />
                  </ListItem>
                </List>
              </Paper>
            </Grid>
                ...
                <Grid item xs={12} md={6} sx={{ textAlign: "left" }}>
                  ...
                  <Box sx={{ display: "flex", flexDirection: "column", gap: 1.5 }}>
                    {[
                      ...
                      "OD vs Term loan comparison matrix",
                    ].map((item, idx) => (
