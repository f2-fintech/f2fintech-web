    ...
    return {
      Enter: () => {
        ...
        if ( $from.nodeBefore && $from.nodeBefore.type.name === 'image' ) {
          const transaction = state.tr.insert( $from.pos, state.schema.nodes.paragraph.create() );
...
const TiptapEditor = ( { content, setContent, onImageUpload, editorOptions = {} } ) => {
  ...
  return (
    <Box sx={ { maxWidth: 960, mx: "auto", color: "white" } }>
      ...
      >
        ...
        <DialogContent>
          <Box sx={ { display: 'flex', flexDirection: 'column', gap: 3, mt: 2 } }>
            ...
            <Alert severity="info">
              Tip: Images will be uploaded to cloud storage when you publish the blog.
            </Alert>
          </Box>
        </DialogContent>
        <DialogActions>
      ...
      <Box sx={ { mt: 1 } }>
        <MuiTypography variant="body2" color="text.secondary">
          💡 Tip: Images will be stored temporarily and uploaded to S3 when you publish.
        </MuiTypography>
      </Box>
