...
const bankDetails = {
  ...
  LendingKart: {
    logo: "eligibility_lendingkart.webp",
    minInterest: 11.5,
    maxInterest: 19.5,
    minTenure: 3,
    maxTenure: 36,
  ...
  KreditBee: {
    logo: "eligibility_kreditbee.webp",
    minInterest: 12.0,
    maxInterest: 21.0,
    minTenure: 3,
    maxTenure: 24,
  ...
  PaySense: {
    logo: "eligibility_paysense.webp",
    minInterest: 12.5,
    maxInterest: 22.0,
    minTenure: 3,
    maxTenure: 24,
